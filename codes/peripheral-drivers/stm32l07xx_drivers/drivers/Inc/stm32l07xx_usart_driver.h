...
#ifndef INC_STM32L07XX_USART_DRIVER_H_
#define INC_STM32L07XX_USART_DRIVER_H_

#include "stm32l07xx.h"

/*
 * This is the configuration structure for USARTx peripheral
 * */
typedef struct {
	uint8_t USART_DeviceMode;				/*!< Master selection >*/
	uint32_t USART_Baud;					/*!< USART baudrate value in bps >*/
	uint8_t USART_NoOfStopBits;				/*!< Number of Stop bits >*/
	uint8_t USART_WordLength;				/*!< Word length >*/
	uint8_t USART_ParityControl;			/*!< Parity control bit >*/
	uint8_t USART_HWFlowControl;			/*!< Hardware flow control >*/
} USART_Config_t;

/*
 * This is a Handle structure for USARTx peripheral
 * */

typedef struct {
	USART_RegDef_t *pUSARTx;				/* The base address of the USARTx peripheral */
	USART_Config_t USART_Config;			/* USARTx configuration settings */
...
#define SUART_STD_BAUD_4M 					4000000
...
#endif /* INC_STM32L07XX_USART_DRIVER_H_ */
