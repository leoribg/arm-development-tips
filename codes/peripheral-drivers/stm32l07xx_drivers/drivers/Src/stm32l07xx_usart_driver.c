...
void USART_Init(USART_Handle_t *pUSARTHandle) {
	...
	if (pUSARTHandle->USART_Config.USART_DeviceMode == USART_MODE_ONLY_RX) {
		//Implement the code to enable the Receiver bit field
		tempreg |= (1 << USART_CR1_RE);
	} else if (pUSARTHandle->USART_Config.USART_DeviceMode == USART_MODE_ONLY_TX) {
		//Implement the code to enable the Transmitter bit field
		tempreg |= (1 << USART_CR1_TE);

	} else if (pUSARTHandle->USART_Config.USART_DeviceMode == USART_MODE_TXRX) {
